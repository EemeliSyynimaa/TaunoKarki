...
{
	if (keyboardState[SDL_SCANCODE_UP] && !arrowPressed)
	{
	...
	else if (keyboardState[SDL_SCANCODE_DOWN] && !arrowPressed)
	{
	...
	else if (!keyboardState[SDL_SCANCODE_UP] && !keyboardState[SDL_SCANCODE_DOWN]) arrowPressed = false;
