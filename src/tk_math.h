...
inline f32 f32_radians(f32 degrees)
{
...
inline f32 f32_degrees(f32 radians)
{
...
inline f32 f32_atan(f32 y, f32 x)
{
    // Todo: implement own atan(2) function
    return atan2f(y, x);
}

inline f32 f32_acos(f32 value)
{
...
inline f32 f32_sin(f32 angle)
{
    // Todo: implement own sin function
    return sinf(angle);
}

inline f32 f32_cos(f32 angle)
{
    // Todo: implement own cos function
    return cosf(angle);
}

inline f32 f32_tan(f32 angle)
{
...
inline f32 f32_square(f32 value)
{
...
inline f32 f32_distance(f32 ax, f32 ay, f32 bx, f32 by)
{
...
inline f32 f32_distance_squared(f32 ax, f32 ay, f32 bx, f32 by)
{
...
inline void f32_swap(f32* a, f32* b)
{
    f32 t = *a;
    *a = *b;
    *b = t;
...
inline f32 f32_round(f32 value)
{
...
inline f32 determinant(f32* values, u32 size)
{
...
inline f32 m2_determinant(struct m2 a)
{
...
inline f32 m3_determinant(struct m3 a)
{
...
inline f32 m4_determinant(struct m4 a)
{
...
inline struct m3 m3_matrix_of_minors(struct m3 a)
{
    struct m3 result = { 0 };
...
inline struct m3 m3_matrix_of_cofactors(struct m3 a)
{
    struct m3 result = { 0 };
...
inline struct m3 m3_transpose(struct m3 a)
{
    struct m3 result = { 0 };
...
inline struct m3 m3_mul_f32(struct m3 a, f32 b)
{
    struct m3 result = { 0 };
...
inline struct m4 m4_matrix_of_cofactors(struct m4 a)
{
    struct m4 result = { 0 };
...
inline struct m4 m4_transpose(struct m4 a)
{
    struct m4 result = { 0 };
...
inline struct m4 m4_matrix_of_minors(struct m4 a)
{
    struct m4 result = { 0 };
...
inline struct m4 m4_translate(f32 x, f32 y, f32 z)
{
    struct m4 result =
    {{
        { 1.0f, 0.0f, 0.0f, 0.0f },
...
inline struct m4 m4_rotate_x(f32 angle)
{
    f32 c = f32_cos(angle);
    f32 s = f32_sin(angle);
...
inline struct m4 m4_rotate_y(f32 angle)
{
    f32 c = f32_cos(angle);
    f32 s = f32_sin(angle);
...
inline struct m4 m4_rotate_z(f32 angle)
{
    f32 c = f32_cos(angle);
    f32 s = f32_sin(angle);
...
inline struct m4 m4_scale_xyz(f32 x, f32 y, f32 z)
{
    struct m4 result =
    {{
        {    x, 0.0f, 0.0f, 0.0f },
...
inline struct m4 m4_scale_all(f32 s)
{
    return m4_scale_xyz(s, s, s);
}

inline struct m4 m4_mul_m4(struct m4 a, struct m4 b)
{
    struct m4 result = { 0 };
...
inline struct m4 m4_mul_f32(struct m4 a, f32 b)
{
    struct m4 result = { 0 };
...
inline struct v4 m4_mul_v4(struct m4 a, struct v4 b)
{
    struct v4 result = { 0 };
...
inline struct m4 m4_inverse(struct m4 a)
{
    struct m4 result = { 0 };
...
inline b32 v4_equals(struct v4 a, struct v4 b)
{
    return a.x == b.x && a.y == b.y && a.z == b.z && a.w == b.w;
}

inline f32 v3_length(struct v3 v)
{
...
inline f32 v3_dot(struct v3 a, struct v3 b)
{
...
inline struct v3 v3_cross(struct v3 a, struct v3 b)
{
    struct v3 result;
...
inline struct v3 v3_normalize(struct v3 v)
{
    struct v3 result = { 0 };
...
inline struct v3 v3_from_v2(struct v2 v, f32 z)
{
    struct v3 result = { 0 };
...
inline b32 v3_equals(struct v3 a, struct v3 b)
{
    return a.x == b.x && a.y == b.y && a.z == b.z;
}

inline struct v3 v3_direction(struct v3 start, struct v3 end)
{
    struct v3 result;
...
inline struct v3 v3_mul_f32(struct v3 a, f32 b)
{
    struct v3 result;
...
inline f32 v2_length(struct v2 v)
{
...
inline f32 v2_length_squared(struct v2 v)
{
...
inline f32 v2_cross(struct v2 a, struct v2 b)
{
...
inline b32 v2_is_zero(struct v2 v)
{
...
inline f32 v2_distance_squared(struct v2 a, struct v2 b)
{
...
inline f32 v2_angle(struct v2 a, struct v2 b)
{
...
inline f32 f32_angle(f32 ax, f32 ay, f32 bx, f32 by)
{
    f32 result;
...
inline struct v2 v2_normalize(struct v2 v)
{
    struct v3 temp;
    struct v2 result;
...
inline struct v2 v2_direction(struct v2 start, struct v2 end)
{
    struct v2 result;
...
inline struct v2 v2_direction_from_angle(f32 angle)
{
    struct v2 result;
...
inline b32 v2_equals(struct v2 a, struct v2 b)
{
    return a.x == b.x && a.y == b.y;
}

inline struct v2 v2_mul_f32(struct v2 a, f32 b)
{
    struct v2 result;
...
inline struct v2 v2_add_f32(struct v2 a, f32 b)
{
    struct v2 result;
...
inline struct v2 v2_sub_f32(struct v2 a, f32 b)
{
    struct v2 result;
...
inline void v2_swap(struct v2* a, struct v2* b)
{
    struct v2 t = *a;
    *a = *b;
    *b = t;
...
inline struct v2 v2_mul(struct v2 a, struct v2 b)
{
    struct v2 result;
...
inline struct v2 v2_average(struct v2 a, struct v2 b)
{
    struct v2 result;
...
inline struct v2 v2_rotate(struct v2 a, f32 angle)
{
    struct v2 result;
...
inline struct v2 v2_flip(struct v2 a)
{
    struct v2 result;
...
inline struct v2 v2_abs(struct v2 v)
{
...
inline struct m4 m4_perspective(f32 fov, f32 aspect, f32 near, f32 far)
{
...
inline struct m4 m4_orthographic(f32 left, f32 right, f32 bottom, f32 top, f32 near,
    f32 far)
{
...
inline struct m4 m4_look_at(struct v3 position, struct v3 target, struct v3 up)
{
    struct v3 forward =
    {
        position.x - target.x,
...
inline struct v4 v4_mul(struct v4 a, struct v4 b)
{
    struct v4 result;
...
inline f32 f32_triangle_area_signed(struct v2 a, struct v2 b, struct v2 c)
{
    f32 result;
