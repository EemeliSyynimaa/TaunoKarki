...
bool Tilemap::roomConflictsWithOthers(unsigned int roomX, unsigned int roomY, unsigned int roomW, unsigned int roomH)
{
...
void Tilemap::carveRoom(unsigned int roomX, unsigned int roomY, unsigned int roomW, unsigned int roomH)
{
	startRegion();
